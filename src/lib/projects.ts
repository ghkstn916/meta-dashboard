...
export const projects: Project[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "lesson-2026ai_ch4_ai_challenge", name: "AI 챌린지 8차시 (생성형+에이전틱)", desc: "고3 AI 기초 8차시 전체 구현 — 워밍업·시각화·이미지(GPT Image 2)·구조화·한계·도구(멀티턴)·리액트(기획서)·프로젝트(조 토론·코멘트). 학생: /join에서 학번+API키 / 교사: /teacher (비번: teacher2024)", tech: "React+Supabase", url: "https://lesson-2026aich4aichallenge.vercel.app", group: "인공지능 기초" },
