...
export const projects: Project[] = [
  ...
  },
  {
    ...
    children: [
      ...
      { id: "lesson-2026ai_api_connect", name: "🔌 내 작품에 API 붙이기", desc: "작품을 만들던 학생이 API·서버·DB를 붙이는 단계로 넘어가는 단일 실습 페이지 8단계 — 내가 할 일/API란/요청과 응답(Open-Meteo 실시간 데모)/키와 서버/AI 기능 넣기(학교 프록시 데모 내장)/DB(Supabase·RLS)/전체 지도/제출 전 점검표. 코드는 Claude에게 맡기는 개념 중심 구성이라 단계마다 설명 그림 + Claude에게 부탁하는 문장(복사) + 받은 코드 검토 체크리스트를 두고, 코드 블록은 접어 둔다. 웹(fetch)·파이썬(Colab) 두 트랙 토글.", tech: "React", url: "https://lesson-2026aiapiconnect.vercel.app", group: "인공지능 기초" },
      ...
      { id: "lesson-2026ai_ch4", name: "AI 4장 — 사회적 영향과 윤리 (2차시)", desc: "고3 AI 기초 2학기 4단원 1주일 분량(2차시·5레슨) — 생성형 AI의 영향력·데이터 편향 실험실 / 윤리적 딜레마(공리주의·의무주의)·책임 배분 / 수행평가 글쓰기 개요(사이트에서 개요, 최종 글은 클래스룸). 교사: /admin", tech: "React+Supabase", url: "https://lesson-2026aich4.vercel.app", group: "인공지능 기초" },
